...
function getAllInf() {
    getData("GET", "http://127.0.0.1:5000/info", null, function() {
...
function deleteInf(event) {
    ...
    getData("DELETE", "http://67.216.211.146:3000/contacts/" + obj.parentNode.parentNode.getAttribute('id'), null, function() {
        if (xmlhttp.readyState == 4) {
            if (xmlhttp.status == 200) {
...
function updateInf(event) {
    ...
    if (!name.value) {
        ...
        console.log(info);
        getData("PUT", "http://67.216.211.146:3000/contacts/" + parent.getAttribute('id'), JSON.stringify(info), function() {
            if (xmlhttp.readyState == 4) {
                if (xmlhttp.status == 200) {
...
addEvent(document.forms.addInf, "submit", function(event) {
    ...
    if (!form.name.value) {
        ...
        console.log(info);
        getData("POST", "http://67.216.211.146:3000/contacts", JSON.stringify(info), function() {
            if (xmlhttp.readyState == 4) {
                if (xmlhttp.status == 200) {
